...
<head>
    ...
    <!-- Favicon icon -->
	<link rel="icon" type="image/png" sizes="16x16" href="images/logo 7.png">
    <title>Culinary - Admin Dashboard</title>
    <!-- Bootstrap Core CSS -->
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">
                        <!-- Logo icon -->
                        <b><img src="images/logo 7.png" alt="homepage" class="dark-logo" width = "50px"/></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span><b>Culinary</b></span>
                    </a>
                </div>
                <!-- End Logo -->
                                        ...
                                        <div class="row">
											 ...
											 <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="o_days" class="form-control custom-select" data-placeholder="Choose a Category" tabindex="1">
														...
														<option value="24hr-x7">setiap hari</option>
                                                    </select>
                                                </div>
                                            </div>
											...
											<div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="file" name="file"  placeholder="12n">
                                                    </div>
                                            </div>
                                            <!--/span-->
