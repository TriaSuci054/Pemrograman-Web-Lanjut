                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                                <div class="pull-left right-text white-txt">
                                    ...
                                    <ul class="nav nav-inline">
                                        <li class="nav-item"> <a class="nav-link active" href="#"><i class="fa fa-check"></i> Min Rp 100000</a> </li>
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >Rp <?php echo $product['price']; ?></span>
										  <input class="b-r-0" type="text" name="quantity"  style="margin-left:60px;" value="1" size="2" />
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-5 additional-info color-gray">
                            <h5>Who are we?</h5>
                            <p>Culinary beridir pada tahun 2020 bertujuan untuk melestarikan makanan khas nusantara</p>
                        </div>
                    </div>
                </div>
                <!-- bottom footer ends -->
